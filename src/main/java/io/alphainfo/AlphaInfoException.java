 ...
 *
 * <p>Catch this at the boundary; use subclasses or {@code instanceof} to
 * react differently to {@link AuthException}, {@link RateLimitException},
 * {@link ValidationException}, {@link NotFoundException}, {@link ApiException},
...
public class AlphaInfoException extends RuntimeException {
    ...
    public AlphaInfoException(
            String message, int statusCode, Map<String, Object> responseData) {
