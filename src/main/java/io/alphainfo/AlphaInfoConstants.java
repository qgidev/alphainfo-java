 ...
 *
 * <p>Values are kept in sync with the server's
...
public final class AlphaInfoConstants {
     ...
     * {@code fingerprint_available = false} with
     * {@code fingerprint_reason = "signal_too_short"}.
     */
    public static final int MIN_FINGERPRINT_SAMPLES = 192;

    /**
     * Minimum signal length with a comparable baseline. The baseline
     * supplies the reference window so the engine can decompose shorter
     * signals.
     */
