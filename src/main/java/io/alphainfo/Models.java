...
/**
 * Typed response models (public contract). Jackson-annotated POJOs so the SDK compiles cleanly on
 * Java 11 without requiring records.
 */
public final class Models {
  ...
  /**
   * Inference block returned when the caller passed {@code domain="auto"}. Null on the {@link
   * AnalysisResult} for any other domain value.
   */
  @JsonIgnoreProperties(ignoreUnknown = true)
   ...
   *
   * <p>Every {@code sim*} field is {@code null} (not 0.0) when the engine could not compute that
   * dimension. Always check {@link #isComplete()} before calling {@link #getVector()}.
   */
  @JsonIgnoreProperties(ignoreUnknown = true)
  public static final class FingerprintResult {
    ...
    /**
     * The 5D fingerprint as a list ready for ANN indexing (pgvector, Qdrant, Faiss). Returns {@code
     * null} when {@link #fingerprintAvailable} is {@code false} — callers must skip on null instead
  ...
  public static final class AnalyzeRequest {
    ...
    public AnalyzeRequest signal(List<Double> s) {
      this.signal = s;
      return this;
    }

    public AnalyzeRequest samplingRate(double s) {
      this.samplingRate = s;
      return this;
    }

    public AnalyzeRequest domain(String d) {
      this.domain = d;
      return this;
    }

    public AnalyzeRequest baseline(List<Double> b) {
      this.baseline = b;
      return this;
    }

    public AnalyzeRequest metadata(Map<String, Object> m) {
      this.metadata = m;
      return this;
    }

    public AnalyzeRequest includeSemantic(boolean v) {
      this.includeSemantic = v;
      return this;
    }

    public AnalyzeRequest useMultiscale(boolean v) {
      this.useMultiscale = v;
      return this;
    }
  }
  ...
  public static final class BatchRequest {
    ...
    public BatchRequest signals(List<List<Double>> s) {
      this.signals = s;
      return this;
    }

    public BatchRequest samplingRate(double s) {
      this.samplingRate = s;
      return this;
    }

    public BatchRequest domain(String d) {
      this.domain = d;
      return this;
    }

    public BatchRequest baselines(List<List<Double>> b) {
      this.baselines = b;
      return this;
    }

    public BatchRequest includeSemantic(boolean v) {
      this.includeSemantic = v;
      return this;
    }

    public BatchRequest useMultiscale(boolean v) {
      this.useMultiscale = v;
      return this;
    }
  }
  ...
  public static final class MatrixRequest {
    ...
    public MatrixRequest signals(List<List<Double>> s) {
      this.signals = s;
      return this;
    }

    public MatrixRequest samplingRate(double s) {
      this.samplingRate = s;
      return this;
    }

    public MatrixRequest domain(String d) {
      this.domain = d;
      return this;
    }

    public MatrixRequest useMultiscale(boolean v) {
      this.useMultiscale = v;
      return this;
    }
  }
  ...
  public static final class VectorRequest {
    ...
    public VectorRequest channels(Map<String, List<Double>> c) {
      this.channels = c;
      return this;
    }

    public VectorRequest samplingRate(double s) {
      this.samplingRate = s;
      return this;
    }

    public VectorRequest domain(String d) {
      this.domain = d;
      return this;
    }

    public VectorRequest baselines(Map<String, List<Double>> b) {
      this.baselines = b;
      return this;
    }

    public VectorRequest includeSemantic(boolean v) {
      this.includeSemantic = v;
      return this;
    }

    public VectorRequest useMultiscale(boolean v) {
      this.useMultiscale = v;
      return this;
    }
  }
